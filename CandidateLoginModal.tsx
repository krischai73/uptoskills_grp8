...
export function CandidateLoginModal() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Candidate Login</DialogTitle>
          <DialogDescription>Enter your credentials to access the candidate portal.</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="candidate-password" className="text-right">
              Password
            </Label>
            <Input
